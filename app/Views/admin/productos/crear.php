        ...
        <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="number" name="Producto_Costo" value="<?php echo $producto->Producto_Costo?>" class="form-control" id="exampleInputPassword1">
            </div>
            <?php 
            ...
            <div class="mb-3">
                ...
                <select name="Producto_Marca" id="">
                    ...
                    ?>
                        <option value="<?php echo $marca->Marca_Id ?>"><?php echo $marca->Marca_Nombre ?></option>
                    <?php
                        endforeach
                    ?>
                </select>
            ...
            <?php 
                if(isset($errores["Producto_Img"]) ){
                    echo "<div class='alerta'>".$errores["Producto_Img"]."</div>";
                }
            ?>
